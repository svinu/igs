	...
	public static void claimCreation(UserRole user) {
		...
		do {
			...
			try {
				...
				logger.error("Entered input is not valid");
		...
		if (validatePolicyNumber) {
			...
			do {
				...
				if (validateClaimReason == false) {
					...
					System.err.println("The reason should always starts with uppercase of minimum length 3 characters and maximum length of 30 characters");
					doClaimReason = false;
				} else {
					doClaimReason = true;
				}
			...
			if (validateClaimReason) {
				...
				do {
					...
					if (validateAccidentLocationStreet == false) {
						...
						System.err.println("The Street name should always starts with uppercase of minimum length 3 characters and maximum length of 30 characters");
				...
				if (validateAccidentLocationStreet) {
					...
					do {
						...
						if (validateAccidentCity == false) {
							...
							System.err.println("The City name should always starts with uppercase of minimum length 3 characters and maximum length of 30 characters");
					...
					if (validateAccidentCity) {
						...
						do {
							...
							if (validateAccidentState == false) {
								...
								System.err.println("The State should always starts with uppercase of minimum length 3 characters and maximum length of 30 characters");
